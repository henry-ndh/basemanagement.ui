  ...
  Ranus: () => {
    return (
      <motion.div initial={{ opacity: 0.5 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }} className="space-y-3 mt-4 text-start">
        ...
        <ListUL>
          <li>
            - Ranus là một start-up công nghệ về thời trang may mặc được bắt đầu từ năm 2019, sở hữu các công nghệ độc quyền và khả năng vận hành tự
            động các quy trình sản xuất về thời trang tới người dùng theo định hướng B2C.
          </li>
          <li>
            - Hiện nay Ranus đang phát triển mạnh mẽ với đội ngũ nhân sự trẻ, Ranus đã cũng đã khẳng định được thương hiệu khi tham gia gọi vốn thành
            công tại Shark Tank Việt Nam và sự hợp tác từ Beta Group.
          </li>
        </ListUL>
        ...
        <ListUL>
          ...
          <li>
            - Hiểu sâu về quá trình xây dựng 1 dự án từ lúc bắt đầu (thiết kế, lên ý tưởng,...) đến lúc đến tay người dùng (sản phẩm hoàn thiện).{' '}
          </li>
        </ListUL>
      </motion.div>
    );
  ...
  ISD: () => {
    return (
      <motion.div initial={{ opacity: 0.5 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }} className="space-y-3 mt-4 text-start">
        ...
        <ListUL>
          <li>
            - ISD là một công ty chuyên về lĩnh vực phát triển phần mềm, website, với đội ngũ nhân sự trẻ, năng động và chuyên nghiệp, ISD đã và đang
            phát triển mạnh mẽ trên thị trường Việt Nam. Công ty phụ trách tiếp nhận xử lý các dự án từ các khách hàng trong và ngoài nước với các dự
            án lớn nhỏ khác nhau.
          </li>
  ...
  TNMall: () => {
    return (
      <motion.div initial={{ opacity: 0.5 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }} className="space-y-3 mt-4 text-start">
        ...
        <ListUL>
          <li>
            TN Mall là một dự án của một doanh nghiệp với mong muốn phát triển về mỹ phẩm. Dự án được bắt đầu từ năm 2024, với mục tiêu trở thành một
            trong những trang web cung cấp mỹ phẩm tốt nhất cho người dùng.
          </li>
        </ListUL>
        <TitleResume>2. Vị trí và thời gian làm việc</TitleResume>
        <ListUL>
    ...
    return (
      <motion.div initial={{ opacity: 0.5 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }} className="space-y-3 mt-4 text-start">
        ...
        <ListUL>
          ...
          <li>
            - Là một sân chơi lớn nhằm tạo điều kiện cho sinh viên các trường đại học, cao đẳng trên cả nước trình bày và phát triển các giải pháp
            phần mềm dựa trên công nghệ nguồn mở.
          </li>
        </ListUL>
        <TitleResume>2. Đề tài</TitleResume>
        <ListUL>
          <li>
            - Đề tài của cuộc thi là Phát triển ứng dụng hỗ trợ tra cứu, hỏi đáp tri thức pháp luật dựa trên Bộ pháp điển và CSDL văn bản QPPL sử dụng
        ...
        <ListUL>
          ...
          <li>
            - Ứng dụng đạt hiệu quả cao trong việc truy cập thông tin pháp luật và giải quyết các vấn đề pháp lý. Nhận được nhiều lượt truy cập và
            khen ngợi từ ban tổ chức cũng như mọi người.
          </li>
        </ListUL>
    ...
    return (
      <motion.div initial={{ opacity: 0.5 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }} className="space-y-3 mt-4 text-start">
        ...
        <ListUL>
          ...
          <li>
            - Đội mình đã xây dựng thành công website với giao diện đẹp, tương tác tốt với người dùng. Được đánh giá cao từ ban giám khảo và nhận được
            nhiều lời khen ngợi từ mọi người.
          </li>
        </ListUL>
        <TitleResume>4. Bonus</TitleResume>
        <ListUL>
